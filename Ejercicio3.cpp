...
void recorrerMatriz(int x, float arrrr[][5]);
...
int main()
{
    ...
    int n;
    //input - output
    cout << "Pprograma que calcula la nta final de n estudiantes." << endl;
    ...
    {
        cout << "Numero de elementos a evaluar debe ser menor o igual a 25 y mayor a 0." << endl;
...
float leerMatriz(int n, float arr[][5])
{
    ...
    for(int i = 0; i < n; i++)
    {
        int n = i + 1;
        cout << "----------" << endl;
        cout << "Ingrese la nota del estudiante " << n << " : " << endl;
        for(int j = 0; j < 5; j++)
        {
            int m = j + 1;
