...
int main()
{
    ...
    float prom;
    //input - output
    cout << "Programa que promedia las estaruras de el grupo de estudiantes." << endl;
    ...
    if(n <= 25 && n > 0)
    {
        ...
        cout << "----------" << endl;
        cout << "El promedio de las estaturas es: " << prom << " cm." << endl;
...
float leerArray(int n, float arr [])
{
    ...
    {
        int n = i + 1;
        cout << "Ingrese la estatura del estudiante: " << n << "en cm: " << endl;
        cin >> aux;
        if(aux >= 0)
        {
            arr[i] = aux;
        }else{
            cout << "Ingrese una estatura mayir a 0." << endl;
            i--;
        }
    }
    return arr [0];
